            ...
            if showOrderPage {
                ...
                ScrollView(.vertical, showsIndicators: false, content: {
                    ...
                    VStack(spacing: 0.0) {
                        ...
                        VStack(alignment: .leading, spacing: 0.0) {
                            Text("Minuman asal Pulau Jawa mengandung serat dan rendah lemak  yang baik untuk menurunkan berat badan.")
                            ...
                            ScrollView(.horizontal, showsIndicators: false, content: {
                                // HStack Bundle Photo
                                HStack(spacing: 0.0) {
                                    Image("OrangeBundleOne")
                                        .padding(.trailing, 16.0)
                                    Image("OrangeBundleTwo")
                                        .padding(.trailing, 16.0)
                                    Image("OrangeBundleThree")
                                        .padding(.trailing, 16.0)
                                } // HStack Bundle Photo
                            }) // Scroll View Bundle Photo (Horizontal)
                        } // VStack Food Description & Bundle
...
struct OrangeDetailView_Previews: PreviewProvider {
